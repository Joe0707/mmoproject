...
public class UIGuildApplyItem : ListView.ListViewItem
{
    ...
    {
        MessageBox.Show(string.Format("要通过{0}的公会申请吗"), "审批申请", MessageBoxType.Confirm).OnYes = () =>
        {
    ...
    {
        MessageBox.Show(string.Format("要拒绝{0}的公会申请吗"), "审批申请", MessageBoxType.Confirm).OnYes = () =>
        {
