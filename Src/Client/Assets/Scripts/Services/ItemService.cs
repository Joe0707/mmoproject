...
namespace Services
{
    class ItemService : Singleton<ItemService>,IDisposable
    {
        public ItemService()
        {
            ...
            MessageDistributer.Instance.Subscribe<ItemEquipRequest>(this.OnItemEquip);
        }
        ...
        public void Dispose()
        {
            ...
            MessageDistributer.Instance.Unsubscribe<ItemEquipRequest>(this.OnItemEquip);
        }
        ...
        {
            MessageBox.Show("购买结果" + message.Result + message.Errormsg);
        }

        private void OnItemEquip(object sender, ItemEquipRequest message)
        {
