...
namespace GameServer.Models
{
    class Guild
    {
        ...
        bool JoinApply(NGuildApplyInfo apply)
        {
            ...
            //TODO是否少了申请加入data申请集中的逻辑
            return true;

        }

        bool JoinAppove(NGuildApplyInfo apply)
        {
        ...
        NGuildInfo GuildInfo(Character from)
        {
        ...
        void ExecuteAdmin(GuildAdminCommand command,int targetId,int sourceId)
        {
